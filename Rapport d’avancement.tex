...
\section{Sujet de la thèse
\subsection{Titre de la thèse}
...
\subsubsection{Méthodologie (Matériel et Méthodes)}

\subsubsection{Objectif général}

\subsubsection{Objectifs spécifiques}

\section{Travail réalisé (Résumé des résultats obtenus jusqu’à ce jour)}

\subsection{Déroulement des activités}

\subsection{L’état d’avancement}

\subsection{Les principaux résultats acquis}

\subsection{Les démarches empiriques ou théoriques}

\section{Perspectives de travail pour la 2nde année de thèse}

\section{Modules de formation ECTS }
Modules de formation du Programme de doctorat en sciences de l'ingénieur ULB auxquelles vous avez participé jusqu’ici: 5 ECTS for the Course LANG-B909, 60 h, niveau AVANCÉ 2, B2.2.

\section{Publications résultant des recherches effectuées:}
Conference paper accepted at 3ECEES (The Third European Conference on Earthquake Engineering and Seismology), https://3ecees.ro/ 
Title: « Extracting microseismic ground motion from legacy seismograms ».
Authors: Olivier Debeir 1, Polina Lemenkova1, Raphael S. M. De Plaen2, and Thomas Lecocq 2 
